...
// B_ReadySpell
// ------------
// FIX 2 Probleme von AI_ReadySpell
// ************************************
...
func void B_ReadySpell(var C_NPC slf, var int spell, var int mana)
{
	...
	//{
		//AI_RemoveWeapon (slf);	// AI_ReadySpell DARF NIE zweimal hintereinander aufgerufen werden, ohne da� AI_RemoveWeapon dazwischen kommt (Fehler: "Only one MOB allowed without collision")
	//}

	// ------ Spruch ziehen ------
	AI_ReadySpell (slf, spell, mana);
	
	// AI_ReadySpell() setzt voraus, da�
