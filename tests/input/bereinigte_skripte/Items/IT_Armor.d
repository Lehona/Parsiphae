...
// ******************************************************
instance ITAR_OldTrousers (C_Item)
{
	name 					=	"alte Hose";
...
// ******************************************************
INSTANCE ITAR_FELL (C_Item)
{
	name 					=	"Fellbesetzte Rüstung";
...
//********************************************************************************
const int VALUE_ITAR_PAL_SKEL2	= 500;

INSTANCE ITAR_PAL_SKEL2 (C_Item)
{
	name 					=	"Rüstung des untoten Oberst";
	...
	value 					=	VALUE_ITAR_PAL_SKEL2;

	wear 					=	WEAR_TORSO;
	
	on_equip				=	Equip_ITAR_PAL_SKEL2;
	on_unequip				=	UnEquip_ITAR_PAL_SKEL2;
...
FUNC VOID Equip_ITAR_PAL_SKEL2()
{
	if Npc_IsPlayer (self)
	{
		//Skelarmor_Equipped = TRUE;
                  Mdl_SetVisualBody (self, "hum_body_Naked0", 0,				0,			"Ske_Head", 	1,	0, 			NO_ARMOR);

	};
};
FUNC VOID UnEquip_ITAR_PAL_SKEL2()
{
	if Npc_IsPlayer (self)
	{
		//Skelarmor_Equipped = FALSE;
          Mdl_SetVisualBody (self, "hum_body_Naked0", 0,				0,			"Hum_Head_FatBald", 	Face_N_NormalBart_Dusty,	0, 			NO_ARMOR);
