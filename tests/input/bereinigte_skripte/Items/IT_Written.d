...
INSTANCE ItWr_Morganleft		(C_Item)
{
	...
	scemeName			=	"MAP";
	description			= 	"Morgan hat diesen Brief ind er Höhle zurückgelassen ";
};
func void UseMorganleft ()
{
		...
		nDocID = 	Doc_Create		()			  ;							// DocManager
					...
					Doc_SetFont 	( nDocID,  0, FONT_Book		); 	// -1 -> all pages
					Doc_PrintLine	( nDocID,  0, ""					);
					Doc_PrintLines	( nDocID,  0, "Du hast mir in den vergangen Tagen gut gedient, mein Sklave. Nun da meine Geschäfte hier erlediegt sind, gebe ich dir deinen Willlen zurück, du wirst dich natürlich an nichts erinnern, was du in meinem Namen getan hast. Dein Qualen einens bewussten untoten Daseins werden dir eine Lehre sein mir nie mehr in die Quere zu kommen"					);
