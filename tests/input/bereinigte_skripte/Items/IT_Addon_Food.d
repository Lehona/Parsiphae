...
//-----------------------------
INSTANCE ItFo_Addon_SRum(C_Item)
{
	name 			=	"Rum";
	...
	description		= 	"Seemann's Rum";

        TEXT[1]                 =       "Achtung mind. 80% vol";
...
INSTANCE ItFo_Addon_PGrog(C_Item)
{
	name 			=	"Grog";
	...
	TEXT[1]                 =       "Vorsicht zerfrisst Krüge, nur aus der Flasche trinken";
        TEXT[2]                 =       "";
        TEXT[3]                 =       "Achtung, die Rezeptur könnte das Bewusstsein stören.";
