...
{	
	...
	FUNC VOID Use_Milk()
	{
        ...
        INSTANCE ItFo_PirateBeer (C_Item)
{
	name 				=	"Bier";
	...
	material 			=	MAT_GLAS;
	scemeName			=	"POTIONFAST";
	on_state[0]			=	Use_PirateBeerBeer;

	description			= 	name;
        TEXT[1]				= 	"Piraten Bier";
	TEXT[3]				= 	"Woraus das wohl besteht";
	TEXT[4]				= 	"Man sollte meinen es riecht etwas nach diesem Grog";
        TEXT[5]				= 	NAME_Value;		COUNT[5]	= Value_Beer;

};

	FUNC VOID Use_PirateBeerBeer()
	{
		Npc_ChangeAttribute	(self,	ATR_HITPOINTS_MAX,	HP_Beer);
		Npc_ChangeAttribute	(self,	ATR_HITPOINTS,	HP_Beer);
		var string concatText;
